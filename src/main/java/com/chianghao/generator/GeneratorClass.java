...
public class GeneratorClass {
	...
	public Class<?> create(String packageName,String className) {
		...
		for(PropertyModel property:propertys) {
			...
			String getMethodName = "get"+StringUtils.firstCharacterUpperCase(property.getPropertyName());
			String setMethodName = "set"+StringUtils.firstCharacterUpperCase(property.getPropertyName());
			classContent.append("\n");
			//set 方法
